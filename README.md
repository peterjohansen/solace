# About Gus
Gus is lightweight, cross-platform Java library that provides GUI for simple text applications. The three classes it provides can be used to output text, read text from the user either by request (polling) or by events. It can be thought of as a multifunctional console.
...
The latest version of Gus is 1.0.0 and was released on 25.07.14.
